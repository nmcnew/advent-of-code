...
fn run_day_02() {
    let values = fs::read_to_string("data/day_02.txt").expect("Day 02 data not initialized");
...
fn run_day_04() {
    let values = fs::read_to_string("data/day_04.txt").expect("Day 04 data not initialized");
...
fn run_day_06() {
    let values = fs::read_to_string("data/day_06.txt").expect("Day 06 data not initialized");
    let result = solutions::day_06::part1(&values);
    let result2 = solutions::day_06::part2(&values);
    println!("Part 1: {result}, Part 2: {result2}");
}
fn run_day_07() {
    let values = fs::read_to_string("data/day_07.txt").expect("Day 07 data not initialized");
